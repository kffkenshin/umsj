...
public class BaseFileConfigServiceImpl extends ServiceImpl<BaseFileConfigMapper, BaseFileConfigDO>
    implements IBaseFileConfigService {
      ...
      buildAsyncReloadingCache(
          ...
          new CacheLoader<Long, FileClient>() {
            ...
            public FileClient load(Long id) {
              BaseFileConfigDO config =
                  Objects.equals(CACHE_MASTER_ID, id)
                      ? baseFileConfigMapper.selectByMaster()
                      : baseFileConfigMapper.selectById(id);
              if (config != null) {
                fileClientFactoryImpl.createOrUpdateFileClient(
  ...
  @Resource private FileClientFactory fileClientFactoryImpl;

  @Resource private BaseFileConfigMapper baseFileConfigMapper;
