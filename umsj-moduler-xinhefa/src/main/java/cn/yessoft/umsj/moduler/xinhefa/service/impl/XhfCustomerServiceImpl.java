...
public class XhfCustomerServiceImpl extends ServiceImpl<XhfCustomerMapper, XhfCustomerDO> implements IXhfCustomerService {

    @Resource
    private XhfCustomerMapper xhfCustomerMapper;
