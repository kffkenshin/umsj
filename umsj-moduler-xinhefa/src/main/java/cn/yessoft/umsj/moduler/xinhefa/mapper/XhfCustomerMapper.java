...
public interface XhfCustomerMapper extends YesBaseMapper<XhfCustomerDO> {
  ...
  default PageResult<XhfCustomerDO> pagedQuery(CustomerQueryReqVO reqVO) {
    return selectPage(
        reqVO,
        new LambdaQueryWrapperX<XhfCustomerDO>()
            .likeIfPresent(XhfCustomerDO::getNo, reqVO.getInfo())
            .or()
            .likeIfPresent(XhfCustomerDO::getNameCn, reqVO.getInfo())
            .or()
            .likeIfPresent(XhfCustomerDO::getNameShort, reqVO.getInfo())
            .or()
            .likeIfPresent(XhfCustomerDO::getCusGroup, reqVO.getInfo()));
  }
  ...
  default XhfCustomerDO getByNo(String cusNo) {
    return selectOne(XhfCustomerDO::getNo, cusNo);
  }
  ;
}
